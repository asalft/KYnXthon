...
async def inline_on():
    ...
    await jmubot.send_message(bot, username)
    await asyncio.sleep(1)
    await jmubot.send_message(bot, "البوت المسـاعـد KYnX")
    await asyncio.sleep(1)
    ...
    await jmubot.send_message(bot, username)
    await asyncio.sleep(1)
    await jmubot.send_message(bot, "《البوت المساعد من سورس KYnX| قناة السورس @KYnX2 | مطور السورس @KYnX0 》")
    await asyncio.sleep(1)
    ...
    if not log_chat:
        ...
        try:
            group_id = await jmubot(
                CreateChannelRequest(
                    title="مجموعة السجل KYnX  ",
                    about="مجموعة حفظ الأحداث والتنبيهات الخاصة بسورس KYnX \n\n انضم لقناة السورس @KYnX2",
                    megagroup=True,
                ),
            )
